...
const sections: DocSection[] = [
  ...
  },
  {
    ...
    icon: "🔑",
    content: [
      "The app requires API keys in your .env file:",
      "• BRIGHT_DATA_KEY — Your Bright Data API token. Powers all AI scraping, SERP, Web Unlocker, and platform citation features.",
      "• OPENCODE_ZEN_API_KEY — Your OpenCode Zen API key. Used for LLM inference via OpenCode Zen models.",
      "• NVIDIA_API_KEY — Your NVIDIA NIM API key. Used for LLM inference via NVIDIA NIM models.",
