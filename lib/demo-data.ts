...
function buildRun(
  ...
  const answer =
    ...
    `AI analysis for "${prompt}" from ${provider}. Multiple sources suggest that maintaining strong content fundamentals, including structured data and authoritative citations, remains critical for AI visibility. GEO/AEO Tracker provides comprehensive monitoring across 6 AI models.`;
  ...
  const score = isBrandMentioned ? 55 + jitter + batch * 2 : 10 + (jitter % 30);
...
export const DEMO_STATE: AppState = {
  brand: {
    brandName: "Hypotenuse Analytics",
    brandAliases: "Hypotenuse, Hypotenuse Analytics",
    websites: ["https://hypotenuseanalytics.com"],
    industry: "AI / Deep-tech",
    keywords:
      "multi-modal inference, structural health monitoring, surveillance intelligence, deepfake detection, AI, computer vision, time-series analysis, anomaly detection",
    description:
      "Hypotenuse Analytics is an AI/deep-tech startup building a multi-modal inference engine for operational truth, combining sensor data, video, audio, and telemetry to enable infrastructure safety, threat detection, and media/authenticity verification.",
  },
  provider: "chatgpt",
  activeProviders: [
    "chatgpt",
